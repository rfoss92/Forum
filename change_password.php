<?php
	...
	$passwordage_title = 'Change Your Password';
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if ($password) {
			...
			$query = "UPDATE users SET pass='$password' WHERE user_id={$_SESSION['user_id']} LIMIT 1";
...
<form action="change_password.php" method="post">
	<fieldset>
	<p><strong>New Password:</strong> <input type="password" name="password1" size="20"> <small>At least 10 characters</small></p>
